...
This bot's code was originally developed by [Akshay Saini](https://github.com/akshaymarch7?tab=overview&from=2021-12-01&to=2021-12-27). This program is purely for educational purposes only, do not use this script in order to gain an unfair advantage amongst developers.</P>
